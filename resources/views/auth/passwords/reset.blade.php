...
<![endif]-->
    ...
    <head>
        ...
        <title>Сброс пароля от MOYZHURNAL.COM</title>
...
<div class="wrapper">
                ...
                <div id="header" class="group">
				    ...
				    <div class="inner group" style="margin-top: 20px;">
				        <h3>Добро пожаловать на страничку восстановления!</h3>
                    ...
                    <form role="form" method="POST" action="{{ url('/password/reset') }}">
						...
						<div>
                            ...
                            <label for="email">Адрес электронной почты</label>
								...
								<div>
									<input id="email" type="email" class="INPUT_1" name="email" value="{{ $email or old('email') }}">
                        ...
                        <div>
                            ...
                            <div>
                                <input id="password" type="password" class="INPUT_1" name="password">
                        ...
                        <div>
                            ...
                            <div>
                                <input id="password-confirm" type="password" class="INPUT_1" name="password_confirmation">
						...
						<div>
							<center>
								<button id="butsend" type="submit"  style="margin-top: 1em;">Подтвердить</button>
							</center>
						</div>
                    </form>
        </div>
