...
class NewsCommentController extends SiteController
{
    /**
    ...
    {
        //
        $data = $request->except('_token','comment_post_ID','comment_parent','comment_to_user_id');
        
        $data['news_id'] = $request->input('comment_post_ID');
        $data['parent_id'] = $request->input('comment_parent');
        $data['to_user_id'] = $request->input('comment_to_user_id');
		...
		$post = News::find($data['news_id']);
		
		$post->newscomments()->save($comment);
		//////////////////////////////////
